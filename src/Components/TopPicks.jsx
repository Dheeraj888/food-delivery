...
const TopPicks = () => {
  return (
<>
<h1 className=' text-yellow-500 font-bold text-2xl text-center py-2'>Top picKs</h1>
    ...
    topPicks.map((item)=>{
        return(
            ...
            <div className=' rounded-3xl relative'>
                <div className=' absolute pt-4 w-full h-full bg-black/50 rounded-3xl  text-white'>
